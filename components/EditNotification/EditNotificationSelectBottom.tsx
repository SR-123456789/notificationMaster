...
interface AddNotificationSelectBottomProps {
  isShow: boolean;
  selectedMethod: "clock" | "location";
  onSelectMode: (mode: "clock" | "location") => void;
}

const EditNotificationSelectBottom = ({ isShow,selectedMethod,onSelectMode }:AddNotificationSelectBottomProps) => {
  const [selectClock, setSelectClock] = useState(selectedMethod === "clock");
  const [selectLocation, setSelectLocation] = useState(selectedMethod === "location");
...
export default EditNotificationSelectBottom;
