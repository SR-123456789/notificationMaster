...
interface AddNotificationInputTimeProps {
  setTime: (time: { hour: number; minute: number }) => void;
  notificationTime: { hour: string, minute: string } | undefined;
}

const EditNotificationInputTime = ({
  setTime,
  notificationTime,
  ...
  const [selectedHour, setSelectedHour] = useState(notificationTime?.hour?notificationTime.hour:currentHour);
  const [selectedMinute, setSelectedMinute] = useState(notificationTime?.minute?notificationTime.minute:currentMinute);
...
export default EditNotificationInputTime;
