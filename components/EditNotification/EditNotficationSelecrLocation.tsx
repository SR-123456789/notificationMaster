...
const EditNotificationSelectLocation = ({
  onLocationSelect,
  notificationLocation,
}: AddNotificationSelectLocationProps) => {
  ...
  useEffect(() => {
    const fetchApproximateLocation = async () => {
      console.log(notificationLocation,"fetchApproximateLocation");

      if (notificationLocation.latitude) return;
      console.log(notificationLocation,"fetchApproximateLocation");
      const correctRegion = await getApproximateLocation();
...
export default EditNotificationSelectLocation;
