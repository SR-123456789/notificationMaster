...
interface EditNotificationInputWebPageProps {
  onInputUrl: (url: string) => void;
  notificationURL: string;
}

const EditNotificationInputWebPage = ({ onInputUrl ,notificationURL}:EditNotificationInputWebPageProps) => {
...
export default EditNotificationInputWebPage;
